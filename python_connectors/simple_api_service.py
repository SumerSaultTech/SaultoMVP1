"""
Simplified Flask API service for managing Python connectors without pandas dependency.
...
from .simple_connector_manager import simple_connector_manager
...
def health_check():
    ...
    return jsonify({
        ...
        "version": "simple",
        "note": "Simplified connector service (no pandas dependency)"
    })
...
def get_available_connectors():
    ...
    try:
        connectors = []
        for connector_type in simple_connector_manager.get_available_connectors():
            requirements = simple_connector_manager.get_connector_requirements(connector_type)
...
def test_connector(company_id, connector_type):
    ...
    try:
        success, message = simple_connector_manager.test_connector(company_id, connector_type)
...
def get_connector_tables(company_id, connector_type):
    ...
    try:
        success, tables, error = simple_connector_manager.get_connector_tables(company_id, connector_type)
...
def sync_connector(company_id, connector_type):
    ...
    try:
        ...
        result = simple_connector_manager.sync_connector(company_id, connector_type, tables)
...
def get_connector_status(company_id, connector_type):
    ...
    try:
        status = simple_connector_manager.get_connector_status(company_id, connector_type)
...
def remove_connector(company_id, connector_type):
    """Remove a connector"""
    try:
        success = simple_connector_manager.remove_connector(company_id, connector_type)
...
def sync_all_connectors(company_id):
    ...
    try:
        results = simple_connector_manager.sync_all_connectors(company_id)
