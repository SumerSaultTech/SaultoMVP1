"""
Connector manager for handling multiple API connectors and orchestrating data syncs.
"""
...
class ConnectorManager:
    """Manages multiple API connectors for a company"""
    ...
    def get_connector_requirements(cls, connector_type: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": f"{connector_type.title()} API connector"
        }
    ...
    def get_connector(self, company_id: int, connector_type: str) -> Optional[BaseConnector]:
    ...
    def remove_connector(self, company_id: int, connector_type: str) -> bool:
        ...
        try:
            ...
            if connector_key in self.active_connectors:
                ...
                connector = self.active_connectors[connector_key]
                if hasattr(connector, 'close_snowflake_connection'):
                    connector.close_snowflake_connection()
