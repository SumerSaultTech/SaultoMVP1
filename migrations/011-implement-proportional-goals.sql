-- Migration to implement proportional goal breakdown in ETL function
-- This updates the ETL function to calculate daily goals based on goal_type (yearly, quarterly, monthly)
